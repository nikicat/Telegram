...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFFB960F0;        // Purplegram brand purple (was Telegram blue 0xFF229AF0); used for the intro logo + page dots
    public static final int TELEGRAM_COLOR_TEXT = 0xFFA25BCF;   // Purplegram brand purple, darker (was 0xFF298ACF)
